...
| Khi vào phần muốn đọc, sẽ hiện ra tên tác phẩm, tên phần muốn đọc, nội dung. Các điều chỉnh sẽ là chế độ sách hoặc tối, điều chỉnh cỡ chữ. Ngoài ra sẽ có các nút chức năng khác như nút in phần đang đọc, nút đọc phần đầu, nút đọc phần trước, nút đọc phần tiếp theo, nút đọc phần mới nhất, nút đọc từ đầu. |
...
![Biểu đồ phân cấp chức năng](FHD.drawio.svg)
