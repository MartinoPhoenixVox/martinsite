...
- Added a `docs/` folder containing per-phase templates to enforce the project's development flow: `1-planning.md`, `2-analysis.md`, `3-design.md`, `4-implementation.md`, and `5-maintenance.md`.
- Added `website/static/docs/` (with a README) to host public diagrams (UML/ER) intended for embedding in site templates.

### Changed (0.1.1)

- Updated `README.md` to document the PLANNING → ANALYSIS → DESIGN → IMPLEMENTATION → MAINTENANCE process and to provide guidance for storing and referencing diagrams (`website/static/docs/` and `docs/`).
- Update CHANGELOG.
